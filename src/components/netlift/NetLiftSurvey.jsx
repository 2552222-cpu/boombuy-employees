...
const QUESTIONS = [
  ...
  {
    id: "insurance_use",
    title: "אם תהיה לך זכאות להצטרף לביטוח רכב ודירה בתעריף מוזל דרך הפלטפורמה — חיסכון של לפחות 10% על הפרמיה השנתית — תצטרף?",
    sub: "ללא שינוי בתנאי הכיסוי, רק מחיר נמוך יותר",
    options: [
      { label: "כן, בוודאי", value: 1.0 },
      { label: "כנראה שכן", value: 0.65 },
      { label: "צריך לבדוק", value: 0.3 },
      { label: "לא רלוונטי לי", value: 0 },
    ],
  },
];
